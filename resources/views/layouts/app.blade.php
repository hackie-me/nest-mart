    ...
    <section class="home-slider position-relative mb-30">
        <div class="home-slide-cover">
            <div class="hero-slider-1 style-4 dot-style-1 dot-style-1-position-1">
                <div class="single-hero-slider rectangle single-animation-wrap" style="background-image: url({{asset("assets/imgs/slider/slider-5.png")}})">
                ...
                <div class="single-hero-slider rectangle single-animation-wrap" style="background-image: url({{asset("assets/imgs/slider/slider-1.png")}})">
                    <div class="slider-content">
                        <h1 class="display-2 mb-40">
                            Fresh Vegetables<br />
                            Big discount
                                ...
                                <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                    <div class="product-cart-wrap mb-30">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2><a href="#">Blue Diamond Almonds Lightly</a></h2>
                                            <div class="product-rate-cover">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width: 90%"></div>
                                                </div>
                                ...
                                <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                    <div class="product-cart-wrap mb-30">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2><a href="#">Chobani Complete Vanilla Greek</a></h2>
                                            <div class="product-rate-cover">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width: 90%"></div>
                                                </div>
                                ...
                                <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                    <div class="product-cart-wrap mb-30">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2><a href="#">Gorton’s Beer Battered Fish Fillets</a></h2>
                                            <div class="product-rate-cover">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width: 90%"></div>
                                                </div>
        ...
        <div class="container">
            ...
            <div class="carausel-8-columns-cover position-relative">
                <div class="carausel-8-columns" id="carausel-8-columns">
                    ...
                    <div class="card-1">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="assets/imgs/theme/icons/category-2.svg" alt="" /></a>
                        </figure>
                        <h6>
                            <a href="#">Wines & <br />
                                Alcohol</a>
                    ...
                    <div class="card-1">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="assets/imgs/theme/icons/category-3.svg" alt="" /></a>
                        </figure>
                        <h6>
                            <a href="#">Clothing & <br />Beauty</a>
                        </h6>
                    </div>
                    <div class="card-1">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="assets/imgs/theme/icons/category-4.svg" alt="" /></a>
                        </figure>
                        <h6>
                            <a href="#">Pet Foods <br />& Toy</a>
                        </h6>
                    </div>
                    <div class="card-1">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="assets/imgs/theme/icons/category-5.svg" alt="" /></a>
                        </figure>
                        <h6>
                            <a href="#">Packaged <br />fast food</a>
                        </h6>
                    </div>
                    <div class="card-1">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="assets/imgs/theme/icons/category-6.svg" alt="" /></a>
                        </figure>
                        <h6>
                            <a href="#">Baking <br />material</a>
                        </h6>
                    </div>
                    <div class="card-1">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="assets/imgs/theme/icons/category-7.svg" alt="" /></a>
                        </figure>
                        <h6>
                            <a href="#">Vegetables <br />& tubers</a>
                        </h6>
                    </div>
                    <div class="card-1">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="assets/imgs/theme/icons/category-8.svg" alt="" /></a>
                        </figure>
                        <h6>
                            <a href="#">Fresh <br />Seafood</a>
                        </h6>
                    </div>
                    <div class="card-1">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="assets/imgs/theme/icons/category-9.svg" alt="" /></a>
                        </figure>
                        <h6>
                            <a href="#">Noodles <br />Rice</a>
                        </h6>
                    </div>
                    <div class="card-1">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="assets/imgs/theme/icons/category-10.svg" alt="" /></a>
                        </figure>
                        <h6><a href="#">Fastfood</a></h6>
                    </div>
                    <div class="card-1">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="assets/imgs/theme/icons/category-11.svg" alt="" /></a>
                        </figure>
                ...
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                        ...
                        <ul class="contact-infor">
                            ...
                            <li><img src="assets/imgs/theme/icons/icon-email-2.svg" alt="" /><strong>Email:</strong><span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4437252821040a2137306a272b29">[email&#160;protected]</a></span></li>
