                    ...
                    <div class="col-lg-8 mb-40">
                        ...
                        <div class="d-flex justify-content-between">
                            <h6 class="text-body">There are <span
                                        class="text-brand">{{auth()->user()->carts()->count()}}</span> products in your
                                cart
                            </h6>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <form method="post">
                                ...
                                <div class="form-group mb-30">
                                    <textarea name="additional_information" rows="5"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="w-160 mb-5"><a
                                                            href="{{route('product', [$item->product->id, $item->product->name])}}"
